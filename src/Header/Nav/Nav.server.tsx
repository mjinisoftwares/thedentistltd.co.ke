            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 min-w-[300px] max-w-[600px] w-max">
              {item.children!.map((child, j) => (
                <Link
                  ...
                  rel={getRel(child)}
                  className="flex items-start gap-3 p-3 rounded-lg hover:bg-accent/80 hover:text-white transition-all duration-200 group/item"
                  role="menuitem"
                >
                  {/* {child.icon && (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      {child.newTab && (
                        <ExternalLink className="w-3 h-3 text-muted-foreground hover:text-white flex-shrink-0" />
                      )}
                    </div>
                    {child.description && (
                      <div className="text-sm text-muted-foreground hover:text-white mt-0.5 line-clamp-3 leading-relaxed">
                        {child.description}
                      </div>
                    )}
                  </div>
